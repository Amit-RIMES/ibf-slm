...
PUBLIC_STATUS_UI: dict[str, dict[str, str]] = {
    "en": {
        ...
        "cond_glofas_label": "River discharge", "cond_glofas_unit": "m³/s peak",
        "cond_glofas_sub": "{n}-day forecast",
        "cond_rain_label": "7-day rainfall", "cond_rain_unit": "mm total",
        "cond_rain_sub": "to {date}",
        "cond_spi_label": "Drought index", "cond_spi_unit": "SPI-3",
        "cond_spi_sub": "{month}",
        "cond_regional_note": "Regional data — not country-specific",
    ...
    "fr": {
        ...
        "section_conditions": "Conditions actuelles",
        "cond_glofas_label": "Débit fluvial", "cond_glofas_unit": "m³/s pic",
        "cond_glofas_sub": "Prévision {n} jours",
        "cond_rain_label": "Précipitations 7 j.", "cond_rain_unit": "mm total",
        "cond_rain_sub": "jusqu'au {date}",
        "cond_spi_label": "Indice de sécheresse", "cond_spi_unit": "SPI-3",
        "cond_spi_sub": "{month}",
        "cond_regional_note": "Données régionales — non spécifiques au pays",
    ...
    "es": {
        ...
        "cond_glofas_label": "Caudal fluvial", "cond_glofas_unit": "m³/s pico",
        "cond_glofas_sub": "Pronóstico {n} días",
        "cond_rain_label": "Lluvia 7 días", "cond_rain_unit": "mm total",
        "cond_rain_sub": "hasta {date}",
        "cond_spi_label": "Índice de sequía", "cond_spi_unit": "SPI-3",
        "cond_spi_sub": "{month}",
        "cond_regional_note": "Datos regionales — no específicos del país",
    ...
    "pt": {
        ...
        "section_conditions": "Condições atuais",
        "cond_glofas_label": "Caudal fluvial", "cond_glofas_unit": "m³/s pico",
        "cond_glofas_sub": "Previsão {n} dias",
        "cond_rain_label": "Chuva 7 dias", "cond_rain_unit": "mm total",
        "cond_rain_sub": "até {date}",
        "cond_spi_label": "Índice de seca", "cond_spi_unit": "SPI-3",
        "cond_spi_sub": "{month}",
        "cond_regional_note": "Dados regionais — não específicos do país",
    ...
    "id": {
        ...
        "section_conditions": "Kondisi terkini",
        "cond_glofas_label": "Debit sungai", "cond_glofas_unit": "m³/dtk puncak",
        "cond_glofas_sub": "Prakiraan {n} hari",
        "cond_rain_label": "Curah hujan 7 hari", "cond_rain_unit": "mm total",
        "cond_rain_sub": "hingga {date}",
        "cond_spi_label": "Indeks kekeringan", "cond_spi_unit": "SPI-3",
        "cond_spi_sub": "{month}",
        "cond_regional_note": "Data regional — tidak spesifik per negara",
